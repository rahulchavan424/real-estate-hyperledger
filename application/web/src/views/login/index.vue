  ...
  <div class="login-container">
    <el-form ref="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <h3 class="title">Real Estate Transaction System Based on Blockchain</h3>
      </div>
      <el-select v-model="value" placeholder="Select user role" class="login-select" @change="selectGet">
        <el-option
      ...
      <div class="tips">
        <span style="margin-right:20px;">Tips: Choose different user roles to simulate transactions</span>
      </div>
